This is a base node.js project template and it has been prepared by keeping some of the most important code principles and project management recommendations.

- `src` -> Inside the src folder, all the actual source code regarding the project will reside. this will not include any tests.
